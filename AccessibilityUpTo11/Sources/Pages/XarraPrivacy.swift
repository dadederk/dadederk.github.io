...
struct XarraPrivacy: StaticPage {
    var title = "Xarra - Privacy Policy"
    var path = "/apps/xarra/privacy"
                ...
                Section {
                    HStack(alignment: .center) {
                        ...
                        VStack(alignment: .leading) {
                            ...
                            Link("← Back to \(app.title)", target: "/apps/xarra")
    ...
    private func loadPrivacyContent() -> String? {
        let privacyPath = "AppsData/Xarra/privacy.md"
